...
public class ArrayOperations<T> {
    ...
    /**
     * Verifica se l'array passato ha dei duplicati. Implementato aggiungendo l'array ad un set e verificando che
     * contenga tanti elementi quanti la lunghezza dell'array
     * 
