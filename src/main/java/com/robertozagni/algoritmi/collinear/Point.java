...
public class Point implements Comparable<Point> {
   ...
   * y1), then the slope is (y1 - y0) / (x1 - x0). For completness, the slope is defined to be +0.0 if the line segment
   * connecting the two points is horizontal; Double.POSITIVE_INFINITY if the line segment is vertcal; and
   ...
   *         if this point is less than the argument point; and a positive integer if this point is greater than the
   *         argument point
   */
