...
public class MyLinkedList {
     ...
     * nodi collegati al nodo passato. Per ogni nodo della lista passata il costruttore crea un nuovo nodo privato con
     * la referenza al valore del nodo passato. Questo esclude side effect sui puntatori tra nodi, ma non sui valori
    ...
    /**
     * Aggiunge il nodo passato ed i nodi ad esso collegati in modo che alla fine la lista punti all'ultimo della
     * catena. Ritorna il numero di elementi aggiunti. !!! ATTENZIONE ai SIDE EFFECT !!! 1) Questo metodo aggiunge alla
     * lista i nodi di cui viene passata la referenza, per cui A - elementi della lista possono essere variati senza
     * accedere alla lista, rompendo il conteggio dei nodi; B - elementi di cui si hanno riferimenti al di fuori della
     * lista possono venir cambiati dalle operazioni sulla lista. 2) Questo metodo modifica la referenza all'oggetto
     * successivo dei nodi che man mano si trovano in fondo alla lista; 3) Se viene aggiunto un nodo che punta ad un
     * nodo gi� nella lista si crea una referenza circolare.
     * 
    ...
    public static class Node<T> {
        ...
        /**
         * Ritorna il nodo collegato al nodo attuale, cio� il prossimo nodo della lista. Non ci sono garanzie sul tipo
         * di valore collegato al nodo ritornato, ovvero il nodo successivo potrebbe avere un valore di tipo diverso dal
         * nodo corrente.
         * 
